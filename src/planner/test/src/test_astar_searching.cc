...
void initDataset() {
  ...
  std::string filename = dataset_folder_ + "/astar_results_" + timestamp + ".csv";
...
void GoalCallback(const geometry_msgs::PoseStamped::ConstPtr& msg) {
  ...
  if (success == 1) {
    ...
    recordResult("astar_hill", start_pt, end_pt, true, search_time,
                 0, cost);
    ...
    recordResult("astar_hill", start_pt, end_pt, false, search_time, 0, -1.0);
